...
CREATE TABLE users (
    ...
    created_by VARCHAR(255) NOT NULL, -- Tracks who created the user
    updated_at TIMESTAMP NULL ON UPDATE CURRENT_TIMESTAMP, -- Automatically updated timestamp
    updated_by VARCHAR(255) DEFAULT NULL -- Tracks who last updated the user
);

ALTER TABLE users
ADD CONSTRAINT fk_created_by FOREIGN KEY (created_by) REFERENCES users(username),
ADD CONSTRAINT fk_updated_by FOREIGN KEY (updated_by) REFERENCES users(username);

-- Insert default admin user (Password: admin)
INSERT INTO users (username, password, password_updated_at, enabled, created_by)
VALUES ('admin', '$2y$10$cIaSdHJkkn/yo5nIaLaXF.z/EEHZMlqdcjfWq.zz8o.NdSNKeb0YS', NOW(), 1, 'admin');

-- Insert default staff user (Password: staff)
INSERT INTO users (username, password, password_updated_at, enabled, created_by)
VALUES ('staff', '$2y$10$20JJtiQmZ8fPOpFvBdljP.HAW9FXZFS4u2/0/lCGdYg.Kemv28g0.', NOW(), 1, 'staff');
